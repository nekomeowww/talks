 ...
 * - glowHue: number - Optional per-slide hue override
...
// Keep the deck Velin-green through its section opener, then progress to
// Vieval-yellow exactly when the Vieval section begins.
